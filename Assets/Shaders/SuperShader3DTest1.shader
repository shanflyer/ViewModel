	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 CharacterFragment(Varyings input, half vFace : VFACE) : SV_Target
			{
				...
				float3 value=StandardColorRevise(albedo,_StandardColor0,_ColorThreshold0);
                float3 color0=_StandardColor0*value;
			

				albedo=albedo*(1-value);
				

				float3 value1=StandardColorRevise(albedo,_StandardColor1,_ColorThreshold1)*(1-value);
				float3 color1=_StandardColor1*value1;
				value+=value1;
				albedo=albedo*(1-value);

				float3 value2=StandardColorRevise(albedo,_StandardColor2,_ColorThreshold2)*(1-value);
				float3 color2=_StandardColor2*value2;
				value+=value2;
				albedo=albedo*(1-value);

				float3 value3=StandardColorRevise(albedo,_StandardColor3,_ColorThreshold3)*(1-value);
				float3 color3=_StandardColor3*value3;
				value+=value3;
				albedo=albedo*(1-value);
				

				float3 value4=StandardColorRevise(albedo,_StandardColor4,_ColorThreshold4)*(1-value);
				float3 color4=_StandardColor4*value4;
				value+=value4;
				albedo=albedo*(1-value);				

				float3 value5=StandardColorRevise(albedo,_StandardColor5,_ColorThreshold5)*(1-value);
				float3 color5=_StandardColor5*value5;
				value+=value5;
				albedo=albedo*(1-value);

				float3 value6=StandardColorRevise(albedo,_StandardColor6,_ColorThreshold6)*(1-value);
				float3 color6=_StandardColor6*value6;
				value+=value6;
				albedo=albedo*(1-value);

				float3 value7=StandardColorRevise(albedo,_StandardColor7,_ColorThreshold7)*(1-value);
				float3 color7=_StandardColor7*value7;
				value+=value7;
				albedo=albedo*(1-value);

				float3 value8=StandardColorRevise(albedo,_StandardColor8,_ColorThreshold8)*(1-value);
				float3 color8=_StandardColor8*value8;
				value+=value8;
				albedo=albedo*(1-value);
				//return float4(color,1);

				float3 value9=StandardColorRevise(albedo,_StandardColor9,_ColorThreshold9)*(1-value);
				float3 color9=_StandardColor9*value9;
				value+=value9;
				albedo=albedo*(1-value);

				float3 value10=StandardColorRevise(albedo,_StandardColor10,_ColorThreshold10)*(1-value);
				float3 color10=_StandardColor10*value10;
				value+=value10;
				albedo=albedo*(1-value);

				float3 value11=StandardColorRevise(albedo,_StandardColor11,_ColorThreshold11)*(1-value);
				float3 color11=_StandardColor11*value11;
				value+=value11;
				albedo=albedo*(1-value);

				float3 value12=StandardColorRevise(albedo,_StandardColor12,_ColorThreshold12)*(1-value);
				float3 color12=_StandardColor12*value12;
				value+=value12;
				albedo=albedo*(1-value);

                albedo=color0+color1+color2+color3+color4+color5+color6+color7+color8+color9+color10+color11+color12;
